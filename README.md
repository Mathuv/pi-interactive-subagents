...
Set `PI_DISABLE_DESTRUCTIVE_CONFIRM=1` in the parent process to propagate the destructive-confirm disabled state to all child subagents:

```bash
export PI_DISABLE_DESTRUCTIVE_CONFIRM=1
```
